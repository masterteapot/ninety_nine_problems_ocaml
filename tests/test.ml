...
let tests =
 ...
 Modmany (4, "e")] (mod_encode ["a"; "a"; "a"; "a"; "b"; "c"; "c"; "a"; "a"; "d"; "e"; "e"; "e"; "e"]))
       ...
       ; ("rotate a list at nth element" >:: fun _ -> assert_equal (["d"; "e"; "f"; "g"; "h"; "a"; "b"; "c"]
) (rotate ["a"; "b"; "c"; "d"; "e"; "f"; "g"; "h"] 3))
       ; ("remove element from list at i" >:: fun _ -> assert_equal (["a"; "c"; "d"]) (remove_at 1 ["a"; "b"; "c"; "d"]))
       ; ("insert element into list at i" >:: fun _ -> assert_equal (["a"; "alfa"; "b"; "c"; "d"]) (insert_at "alfa" 1 ["a"; "b"; "c"; "d"]))
       ; ("create list of integers within range" >:: fun _ -> assert_equal ([4; 5; 6; 7; 8; 9]) (range 4 9))
       ; ("create list of integers within descending range" >:: fun _ -> assert_equal ([9; 8; 7]) (range 9 7))
...
(* ) (lotto_select 6 49)) *)
       ; ("create a list of all possible permutations" >:: fun _ -> assert_equal ([["a"; "b"]; ["a"; "c"]; ["a"; "d"]; ["b"; "c"]; ["b"; "d"]; ["c"; "d"]]) (extract 2 ["a"; "b"; "c"; "d"]))
       ; ("sort list by inner list lengths" >:: fun _ -> 
...
(* TODO       (* ; ("sort list by their list length frequency" >:: fun _ ->  *) *)
       ...
       ; ("convert numbers into strings" >:: fun _ -> assert_equal ("one-seven-five") (full_words 175))
       ]
;;
